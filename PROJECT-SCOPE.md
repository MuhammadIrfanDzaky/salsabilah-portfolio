...
- **Last audit:** 2026-07-29 (isi artikel jadi dokumen kaya; editor ala pengolah kata)
- **Gates open:** **1 dari 21 blocking** — #29 Env & Secrets, karena `DEEPL_API_KEY`
  belum ada di Vercel. Dihitung dengan membaca kolom Status baris per baris, bukan dari
  ingatan: 20 `applied`, 1 `deferred`. #18 dan #46 ditutup pada audit 2026-07-28.

...
- **Gates open:** **1 dari 21 blocking** — #29 Env & Secrets, karena `DEEPL_API_KEY`
  belum ada di Vercel. #18 dan #46 ditutup pada audit 2026-07-28.
...
**`escapeXml` sebelum `protectTerms`, dan tidak boleh dibalik (2026-07-28).** Perlindungan
glosarium bekerja dengan membungkus istilah dalam `<x>…</x>` lalu memberi tahu DeepL agar
melewatinya. Kalau teks di-escape **setelah** dibungkus, tag itu sendiri ikut jadi `&lt;x&gt;`
— DeepL membacanya sebagai teks biasa, seluruh perlindungan mati, dan **tidak ada satu pun
galat**. Gejalanya cuma draft yang ditolak pemeriksaan akhir dengan alasan "istilah hilang",
yang mengarahkan orang mencurigai mesinnya alih-alih urutan dua baris kode. Terkunci oleh uji
20/20, salah satunya khusus memeriksa `<x>` tidak ter-escape.
